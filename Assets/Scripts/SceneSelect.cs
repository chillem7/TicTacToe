...
public class SceneSelect : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if (GameManager.instance.GetSavedToggle() != 0)
        {
            SetPreviouseToggle();
        }
    }
    ...
    {
        Toggle onToggle = (GameManager.instance.GetSavedToggle() == 3) ? toggle3 : toggle4;

        onToggle.isOn = true;

        Toggle offToggle = (GameManager.instance.GetSavedToggle() != 4) ? toggle3 : toggle4;
    ...
    public void LoadBoard()
    {
        ...
        //Add A end of game to Game Manager List of Moves
        GameManager.instance.AddMove(new Move());
